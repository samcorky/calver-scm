...
@pytest.mark.parametrize(
    ...
    [
        ("2026.4", "2026.4.0"),
        ("2026.4.2", "2026.4.2"),
        ("2026.4.2beta3", "2026.4.2b3"),
        ("2026.4.2.post-2", "2026.4.2.post2"),
        ("2026.4.2.dev-4", "2026.4.2.dev4"),
        ("2026.4.2rc1.post2.dev3+linux.x86_64", "2026.4.2rc1.post2.dev3+linux.x86.64"),
    ],
)
def test_format_month_mode_keeps_canonical_suffixes(
    raw: str,
    expected: str,
) -> None:
    """Render month-mode versions with PEP 440 suffixes."""
...
@pytest.mark.parametrize(
    ...
    [
        ("2026.4.5", "2026.4.5.0"),
        ("2026.4.5.2", "2026.4.5.2"),
        ("2026.4.5.2rc1", "2026.4.5.2rc1"),
    ],
)
...
def test_format_from_base_preserves_suffix_order() -> None:
    ...
    assert (
        version.format_from_base(base="2026.4", patch=7) == "2026.4.7rc1.post2.dev3+abc"
    )
